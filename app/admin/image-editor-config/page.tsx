  ...
  return (
    <Card className="max-w-4xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>配置图像编辑智能体的参数、模型和API密钥</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="mb-4">
          ...
          <Input
            type="number"
            value={config.maxImageSizeMB === undefined ? 5 : config.maxImageSizeMB}
            onChange={e => setConfig({ ...config, maxImageSizeMB: Number(e.target.value) })}
          />
        </div>
        <div className="mb-4">
        ...
        <div className="mb-4">
          ...
          <div className="flex gap-2 mb-1">
            <Input
              placeholder="画笔粗细"
              type="number"
              value={(config.editParams || {}).brushSize === undefined ? 5 : config.editParams.brushSize}
            ...
            <Input
              placeholder="最大编辑步数"
              type="number"
              value={(config.editParams || {}).maxEditSteps === undefined ? 20 : config.editParams.maxEditSteps}
              onChange={e => setConfig({
                ...config,
                editParams: {
                  ...(config.editParams || {}),
