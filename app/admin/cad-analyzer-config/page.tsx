    ...
    <Card className="max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle className="text-xl font-bold flex items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-pantone369-500">
      ...
      <CardContent>
        ...
        {success && (
          <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded mb-4 flex items-start">
            ...
            <div>
              ...
              <p className="text-sm">CAD智能体配置已同时更新到数据库和配置文件</p>
            </div>
          </div>
        )}
        <div className="mb-4">
        ...
        <div className="mb-4">
          ...
          <Input
            type="number"
            value={config.maxFileSizeMB === undefined ? 10 : config.maxFileSizeMB}
        ...
        <div className="mb-4">
          ...
          <Input
            ...
            onChange={e => setConfig({ ...config, supportedFormats: e.target.value ? e.target.value.split(",") : [] })}
          />
        </div>
        <div className="mb-4">
          ...
          <div className="flex gap-2 mb-1">
            ...
            <Input
              placeholder="超时时间(秒)"
              type="number"
              value={(config.analysisParams || {}).timeoutSec === undefined ? 60 : config.analysisParams.timeoutSec}
              onChange={e => setConfig({
                ...config,
                analysisParams: {
                  ...(config.analysisParams || {}),
            ...
            <Input
              placeholder="最大页数"
              type="number"
              value={(config.analysisParams || {}).maxPages === undefined ? 10 : config.analysisParams.maxPages}
              onChange={e => setConfig({
                ...config,
                analysisParams: {
                  ...(config.analysisParams || {}),
        ...
        <div className="mb-4">
          ...
          <Input
            type="number"
            value={config.historyRetentionDays === undefined ? 30 : config.historyRetentionDays}
            onChange={e => setConfig({ ...config, historyRetentionDays: Number(e.target.value) })}
          />
        </div>
        <div className="mb-4">
          ...
          />
          <p className="text-sm text-gray-500 mt-1">CAD智能体API服务的端点URL</p>
        </div>
        <div className="mb-4">
          ...
          <Input
            ...
            placeholder="输入API密钥"
          />
          <p className="text-sm text-gray-500 mt-1">CAD智能体API服务的全局密钥，优先级高于模型列表中的密钥</p>
        </div>
        <div className="mb-4">
            ...
            <div className="py-4">
              <div className="flex items-center text-green-600 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">您的CAD智能体配置已同时更新到数据库和配置文件</p>
                </div>
              </div>
    ...
    <LanguageProvider>
      <AgentProvider>
        <div className="max-w-4xl mx-auto mb-4">
          <Link href="/admin" className="text-pantone369-500 hover:text-pantone369-600 flex items-center gap-1">
