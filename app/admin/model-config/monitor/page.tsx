        ...
        <div className="container mx-auto py-6 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">实时监控AI模型的性能指标和使用情况</p>
            </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 flex items-center gap-1">
                      {getStatusIcon(95, 90)}
                      <span className={getStatusColor(95, 90)}>95% 目标达成</span>
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 flex items-center gap-1">
                      ...
                      <span className={getStatusColor(950, 1000, true)}>低于目标</span>
                    </p>
                  </div>
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-semibold">{model.totalRequests.toLocaleString()}</p>
                        </div>
                        <div>
                      ...
                      <div className="flex justify-between items-center pt-2 border-t">
                        ...
                        <Badge variant="outline">${model.totalCost.toFixed(2)}</Badge>
                      </div>
                    </CardContent>
                  </Card>
                ))}
