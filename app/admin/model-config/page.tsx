...
import type { ModelConfig, ModelConfigQuery } from '@/types/model-config'
...
export default function ModelConfigPage() {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'fastgpt': return 'bg-purple-100 text-purple-800'
            ...
            <TableBody>
              {filteredModels.map((model) => (
                <TableRow key={model.id}>
                  ...
                  <TableCell>{model.metadata.usageCount.toLocaleString()}</TableCell>
                  <TableCell>
