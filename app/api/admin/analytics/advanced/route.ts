    ...
    switch (validatedQuery.type) {
      ...
      default:
        ...
        result = {
          ...
          prediction,
          summary: {
            totalSessions: userBehavior.userRetention.activeUsers.reduce((sum: number, day: any) => sum + day.count, 0),
            activeUsers: userBehavior.userSegments.reduce((sum: number, segment: any) => sum + segment.userCount, 0),
            avgSatisfaction: agentPerformance.satisfactionAnalysis.reduce((sum: number, agent: any) => sum + agent.avgSatisfaction, 0) / agentPerformance.satisfactionAnalysis.length || 0,
