...
// import { sign } from 'jsonwebtoken'; // 暂时注释，避免构建错误
// import nodemailer from 'nodemailer'; // 暂时注释，避免构建错误

// const JWT_SECRET = process.env.JWT_SECRET || 'your-secret-key'; // 暂时注释，避免构建错误
