...
describe('FastGPT参数获取功能测试', () => {
  ...
  describe('全局变量序列化', () => {
    it('应该能够序列化全局变量为JSON字符串', () => {
      const variables: GlobalVariable[] = mockFastGPTResponse.data.app.chatConfig.variables
  ...
  describe('FastGPT响应解析', () => {
    it('应该能够从FastGPT响应中提取基础信息', () => {
      ...
      expect(response.data.app.chatConfig.welcomeText).toContain('AI智能体定制方案设计师')
    })
