...
- Name: FastGPT agent shows welcome message
- Location: F:\jj\ai-chat-interface\__tests__\e2e\user-chat.e2e.spec.ts:18:5
...
Call log:
  - navigating to "/user/chat", waiting until "load"
    ...
    at F:\jj\ai-chat-interface\__tests__\e2e\user-chat.e2e.spec.ts:19:14
```
