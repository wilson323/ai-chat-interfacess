...
- Name: Responsive UI: mobile layout
- Location: F:\jj\ai-chat-interface\__tests__\e2e\user-chat.e2e.spec.ts:70:5
...
Call log:
  - navigating to "/user/chat", waiting until "load"
    ...
    at F:\jj\ai-chat-interface\__tests__\e2e\user-chat.e2e.spec.ts:72:14
```
