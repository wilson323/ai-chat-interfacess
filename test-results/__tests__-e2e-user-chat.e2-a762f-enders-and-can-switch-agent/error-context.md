...
- Name: Agent switcher renders and can switch agent
- Location: F:\jj\ai-chat-interface\__tests__\e2e\user-chat.e2e.spec.ts:4:5
...
Call log:
  - navigating to "/user/chat", waiting until "load"
    ...
    at F:\jj\ai-chat-interface\__tests__\e2e\user-chat.e2e.spec.ts:5:14
```
