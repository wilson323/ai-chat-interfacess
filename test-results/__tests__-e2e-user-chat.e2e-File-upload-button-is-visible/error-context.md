...
- Name: File upload button is visible
- Location: F:\jj\ai-chat-interface\__tests__\e2e\user-chat.e2e.spec.ts:43:5
...
Call log:
  - navigating to "/user/chat", waiting until "load"
    ...
    at F:\jj\ai-chat-interface\__tests__\e2e\user-chat.e2e.spec.ts:44:14
```
