...
export default function DataExport({ className = '' }: DataExportProps) {
  ...
  const selectedDataTypeInfo = dataTypes.find(
              ...
              {dataTypes.map(dataType => {
                ...
                return (
                  ...
                  >
                    <div className='flex items-center gap-3'>
                      <Icon
                        className={`h-5 w-5 ${isSelected ? 'text-green-600' : 'text-gray-500'}`}
                      />
                      <div className='flex-1'>
                        <div className='font-medium text-gray-900'>
                          {dataType.label}
        ...
        <div className='space-y-3'>
          ...
          <div className='flex items-center gap-4 flex-wrap'>
            <div className='flex items-center gap-2'>
              <input
                id='dataExportStartDate'
                name='dataExportStartDate'
                type='date'
                value={startDate}
              ...
              <input
                id='dataExportEndDate'
                name='dataExportEndDate'
                type='date'
                value={endDate}
