...
function ProductCarousel() {
  return (
    ...
    >
      ...
      <Title
        level={5}
        className='text-light-text mb-3.5 flex items-center whitespace-normal'
      >
      ...
      <div className='flex gap-3.5'>
        {products.map(product => (
          ...
          >
            ...
            />
            <div className='text-sm font-medium line-clamp-2 h-10 leading-tight'>
              {product.title}
            </div>
            <div className='text-primary-color font-semibold text-base mt-1.5'>
              ¥{product.price}
            </div>
          </div>
        ))}
