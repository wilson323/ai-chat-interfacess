...
export function MessageList({ messages, isLoading = false, renderMessage }: MessageListProps) {
  ...
  return (
    ...
    >
      <div className={cn("max-w-3xl mx-auto space-y-4 sm:space-y-6", isMdAndDown ? "pb-24" : "pb-32")}>
