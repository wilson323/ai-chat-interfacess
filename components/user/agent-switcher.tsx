      ...
      <>
        ...
        {showList && (
          ...
          >
            ...
            >
              <div className='text-center text-lg font-semibold mb-4 text-pantone369-700 dark:text-pantone369-200'>
                选择智能体
              </div>
              {agents.length === 0 ? (
                  ...
                  {agents.map(agent => (
                    ...
                    >
                      ...
                      <div className='flex-1 min-w-0'>
                        <div className='text-base font-medium text-pantone369-700 dark:text-pantone369-200 truncate'>
                          {agent.name}
                        </div>
                      ...
                      {selectedAgent?.id === agent.id && (
                        <span className='ml-2 text-primary-color dark:text-secondary-color font-bold'>
                          ✓
                        </span>
                      )}
                    </div>
