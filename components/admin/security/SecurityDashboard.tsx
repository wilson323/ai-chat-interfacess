...
import type { SecurityScanResult, SecurityIssue } from '@/lib/security/security-scanner'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`text-3xl font-bold ${getGradeColor(scanResult.summary.grade)}`}>
                    {scanResult.summary.score}
                  </p>
                  <p className="text-sm text-gray-500">等级: {scanResult.summary.grade}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-red-600">{scanResult.criticalIssues}</p>
                </div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">高风险问题</p>
                  <p className="text-3xl font-bold text-orange-600">{scanResult.highIssues}</p>
                </div>
        ...
        <Alert>
          ...
          <AlertDescription>
            <ul className="mt-2 space-y-1">
              {scanResult.summary.recommendations.slice(0, 3).map((rec, index) => (
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center">
                    <div className={`text-6xl font-bold ${getGradeColor(scanResult.summary.grade)}`}>
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                      {scanResult.summary.grade === 'A' && '优秀 - 安全状况良好'}
                      {scanResult.summary.grade === 'B' && '良好 - 存在少量问题'}
                      {scanResult.summary.grade === 'C' && '一般 - 需要改进'}
                      {scanResult.summary.grade === 'D' && '较差 - 存在较多问题'}
                      {scanResult.summary.grade === 'F' && '危险 - 存在严重安全问题'}
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {scanResult.summary.recommendations.map((recommendation, index) => (
      ...
      {!scanResult && (
        <Card>
          <CardContent className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">开始安全扫描</h3>
            <p className="text-gray-600 mb-4">点击下方按钮开始扫描代码中的安全漏洞</p>
