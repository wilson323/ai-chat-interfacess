...
import { getRecordingOptions, getBestAudioFormat } from '@/lib/voice/config';
import {
  handleMediaError,
  handleRecorderError,
  createVoiceError,
  ...
  const startRecording = useCallback(async (): Promise<void> => {
    try {
      ...
      try {
        ...
        console.warn(
          'Failed to create audio context for visualization:',
          error
        );
      }
 ...
 * 获取录音状态描述
 */
export function getRecordingStateDescription(
