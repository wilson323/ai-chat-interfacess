...
import { AlertCircle, CheckCircle, Clock, Mic, MicOff, Loader2 } from 'lucide-react'
    ...
    <div className="flex flex-col items-center gap-3 p-4 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800/30 rounded-lg">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className={cn(
          ...
          isNearLimit ? 'text-red-600 dark:text-red-400' : 'text-red-700 dark:text-red-300'
        )}>
...
export function CompactVoiceStatus({
  ...
  return (
    <div className={cn(
      ...
      error ? 'bg-red-100 dark:bg-red-950/20 text-red-700 dark:text-red-300' :
      isRecording ? 'bg-red-100 dark:bg-red-950/20 text-red-700 dark:text-red-300' :
      ...
      {error ? (
        ...
        <>
          ...
          <VoiceWaveform audioLevel={audioLevel} bars={3} className="text-red-500" />
        </>
      ) : (
        <>
...
export function StatusText({
  ...
  return (
    <span className={cn(
      ...
      status === 'recording' ? 'text-red-700 dark:text-red-300' :
