  ...
  return (
    <button
      className={cn(
        ...
        isEnabled ? 'bg-muted hover:bg-muted/80 text-foreground' :
...
export const VoiceButtonUtils = {
   ...
   * 获取按钮状态描述
   */
  getStateDescription(isRecording: boolean, isProcessing: boolean, isEnabled: boolean): string {
   ...
   * 获取按钮颜色主题
   */
  getColorTheme(isRecording: boolean, isProcessing: boolean, isEnabled: boolean) {
