...
export const ERROR_MESSAGES = {
  NETWORK_ERROR: "抱歉，连接服务器时出现问题。请检查您的网络连接或API配置，然后重试。",
  INCOMPLETE_CONFIG: "API 配置不完整。请配置 API 端点、密钥和 AppId。",
  SERVER_ERROR: "抱歉，服务器返回了一个错误。我将以离线模式为您服务。请问有什么我可以帮助您的？",
  PROCESSING_ERROR: "抱歉，处理您的请求时出现错误。我将以离线模式为您服务。请问有什么我可以帮助您的？",
} 