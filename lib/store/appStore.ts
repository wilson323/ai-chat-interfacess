...
export const useAppStore = create<AppState>()(
  persist(
    immer((set, get) => ({
      ...
      setAgentsLoading: (loading) => set((state) => {
        state.agents.loading = loading
      }),
      
      setAgentsError: (error) => set((state) => {
      ...
      // 聊天相关 Actions
      setCurrentChatId: (chatId) => set((state) => {
      ...
      updateGlobalVariable: (key, value) => set((state) => {
        state.globalVariables[key] = value
      }),
      
      clearGlobalVariables: () => set((state) => {
      ...
      setVoicePlaying: (playing) => set((state) => {
        state.voice.isPlaying = playing
      }),
      
      setVoiceSupported: (supported) => set((state) => {
