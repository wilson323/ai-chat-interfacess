...
export const useRequestActive = () =>
  useAppStore(state => state.chat.isRequestActive);
...
export const useGlobalVariableActions = () =>
  useAppStore(selectors.globalVariableActions);
...
export const useVoiceRecording = () =>
  useAppStore(state => state.voice.isRecording);
export const useVoicePlaying = () =>
  useAppStore(state => state.voice.isPlaying);
 ...
 * 全局变量管理选择器
 */
export const useGlobalVariableManagement = () =>
  useAppStore(state => ({
    globalVariables: state.globalVariables,
