...
export interface DbSchemaApprovalCreationAttributes extends Optional<DbSchemaApprovalAttributes, 'id' | 'approver' | 'status' | 'createdAt' | 'updatedAt'> {}

export class DbSchemaApproval extends Model<DbSchemaApprovalAttributes, DbSchemaApprovalCreationAttributes> implements DbSchemaApprovalAttributes {
  public id!: number
